        ...
        <>
            ...
            <Grid container direction="row" justify="center" alignItems="center">
                <Grid item>
                    <Button
                        color="primary"
                        href={'/generalRecommending/' + '5de7ac4033992859d1d8e76c'}
                    >
                        General Model
                    </Button>
                </Grid>
                <Grid item>
                    <Button
                        color="primary"
                        href={'/overfittingRecommending/' + '5de7ac4033992859d1d8e76c'}
                    >
                        Overfitting
                    </Button>
                </Grid>
                <Grid item>
                    <Button
                        color="primary"
                        href={'/taxonomyRecommending/' + '5de7ac4033992859d1d8e76c'}
                    >
                        Taxonomy
                    </Button>
                </Grid>
                <Grid item>
                    <Button
                        color="primary"
                        href={'/categoryRecommending/' + '5de7ac4033992859d1d8e76c'}
                    >
                        Categories
                    </Button>
                </Grid>
            ...
            <Grid container direction="row" justify="space-evenly" alignItems="stretch">
                <Grid item xs={2}>
                    <CourseCard
                        ...
                        description="Learn to communicate effectively through technical report writingTechnical reports are a vital tool for engineers to communicate their ideas. This online course introduces technical report writing and teaches the techniques you need to construct well-written engineering reports."
                        courseId="technical-report-writing-for-engineers-9087"
                    />
                </Grid>
                <Grid item xs={2}>
                    <CourseCard
